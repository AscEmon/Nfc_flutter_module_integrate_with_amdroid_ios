...
import 'package:nfc_module/model/record.dart';
import 'package:nfc_module/model/write_record.dart';
import 'package:nfc_module/repository/repository.dart';
import 'package:nfc_module/view/common/form_row.dart';
import 'package:nfc_module/view/common/nfc_session.dart';
import 'package:nfc_module/view/edit_external.dart';
import 'package:nfc_module/view/edit_mime.dart';
import 'package:nfc_module/view/edit_text.dart';
import 'package:nfc_module/view/edit_uri.dart';
import 'package:nfc_module/view/ndef_record.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<Iterable<WriteRecord>>(
        stream: Provider.of(context, listen: false).subscribe(),
